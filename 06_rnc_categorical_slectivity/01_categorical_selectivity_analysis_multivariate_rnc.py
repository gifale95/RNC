...
print('>>> Multivariate RNC categorical selectivity analysis <<<')
print('\nInput parameters:')
...
# =============================================================================
# Aggregate the multivariate RNC RSA scores as a function of as a function of
# two areas being from the same or different categorical selectivity groups
# =============================================================================
...
sorted_align = np.zeros((len(all_subjects), len(groups)))
sorted_disentangle = np.zeros((len(all_subjects), len(groups)))
sorted_baseline = np.zeros((len(all_subjects), len(groups)))

# Group the multivariate RNC RSA scores as a function of two areas being from
# the same or different categorical selectivity groups
...
ci_sorted_align = np.zeros((2, len(groups)))
ci_sorted_disentangle = np.zeros((2, len(groups)))
ci_sorted_baseline = np.zeros((2, len(groups)))
...
# Sorted scores arrays of shape:
# (Subjects × 2 categorical selectivity groups comparisons × Iterations)
sorted_align_null_dist = np.zeros((len(all_subjects), len(groups),
	args.n_iter))
...
# Group the multivariate RNC null distribution RSA scores as a function of two
# areas being from the same or different categorical selectivity groups, after
# shuffling the ROIs to which the null distribution scores belong to
