% Multivariate RNC images
% V1-V4 ROI pair
% fMRI data collection
% Multivariate RNC controlling image conditions:
	% 50 Positive correlation (alignment) images (from NSD)
	% 50 Zero-correlation (disentanglement) images (from NSD)
	% 50 Baseline images (from NSD)
% Paradigm:
...
% Directories
stimuli_dir = '../stimuli/multivariate_rnc_controlling_images/V1-V4/imageset-nsd'; % Download from: https://openneuro.org/datasets/ds005503
catch_stimuli_dir = '../stimuli/catch_images'; % Download from: https://openneuro.org/datasets/ds005503
utils_dir = '../06_in_vivo_validation/01_experimental_paradigm/multivariate_rnc_experiment/utils';
stim_order_dir = '../06_in_vivo_validation/01_experimental_paradigm/multivariate_rnc_experiment/stimuli_order';
...
data.paradigm.stimuli_trials_per_run = 100;
data.paradigm.catch_trials_per_run = 5;
data.paradigm.blank_trials_run_start = 3;
data.paradigm.blank_trials_run_middle = 9;
...
data.paradigm.trials_per_run = data.paradigm.stimuli_trials_per_run + ...
	...
	data.paradigm.blank_trials_run_end; % 484s per run (~8m)
data.paradigm.total_runs = 12; % total of 97m + pauses

% Stimuli
data.paradigm.tot_images = 150;
data.paradigm.image_repeats = 8;
...
output_save_dir = [save_dir, slash, 'sub-', ...
	sprintf('%02d', data.subject.id), 'multivariate_rnc_experiment'];
