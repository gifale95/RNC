...
https://github.com/gifale95/RNC/blob/main/06_in_vivo_validation/05_analyses/02_plot_multivariate_rnc_effect.py
...
if data['significance']['rsa_alignment_sig'] == True:
...
if data['significance']['rsa_disentanglement_sig'] == True:
...
#fig.savefig('multivariate_rnc_v1_v4_in_vivo_validation.png', dpi=100, bbox_inches='tight')
