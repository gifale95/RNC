...
#fig.savefig('univariate_rnc_scatterplots_v1_v4_in_vivo_validation.png', dpi=100, bbox_inches='tight')
...
for c, cond in enumerate(control_responses):
	...
	# V1 (significance)
	if data['significance'][cond+'_sig']['V1'] == True:
		if c in [0, 2]:
	...
	# V4 (significance)
	if data['significance'][cond+'_sig']['V4']:
		if c in [0, 3]:
...
#fig.savefig('univariate_rnc_significance_v1_v4_in_vivo_validation.png', dpi=100, bbox_inches='tight')
