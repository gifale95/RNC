function write_glasser_mask_full(cfg,i_sub)
...
evc_hdr.descrip = ['Glasser atlas with all parcels'];
evc_hdr.dt = [2 0];
...
%rename file
movefile(fullfile(cfg.sub(i_sub).dir,'roi',['r',this_roi,'_mask.nii']),fullfile(cfg.sub(i_sub).dir,'roi',[this_roi,'_mask.nii']));
