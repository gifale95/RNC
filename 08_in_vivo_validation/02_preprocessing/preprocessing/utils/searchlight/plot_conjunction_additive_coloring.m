...
function [pic,fh] = plot_conjunction_additive_coloring(hdr_overlay,photo_and_drawing_and_sketch, photo_and_drawing, photo_and_sketch, drawing_and_sketch, only_photo, only_drawing, only_sketch, fig_title,cmap)
...
% manually set colors 
colors(1,:) = cmap(ceil(256),:);
colors(2,:) = cmap(ceil(213),:);
colors(3,:) = cmap(ceil(170),:);
