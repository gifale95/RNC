...
function [pic,fh] = plot_data_on_axial(data_path, mask_path,fig_title,cmap)

% set planes to show 
show_planes=[22:4:60] % axial the planes throught the T1 to be shown
...
% subset the data with the mask from the statistical analysis
...
color_limits= round(linspace(min_val,max_val,100));%scaled globally to overall min max over time
...
set(cl,'Ticks',new_ticks,'FontSize',14,'Color',[0 0 0])
set(gcf,'color','black');
