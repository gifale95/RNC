To perform the pRF mapping, you will first need to create a dedicated Anaconda environment using the .yml environment file https://github.com/gifale95/RNC/tree/main/06_in_vivo_validation/03_prf_mapping/01_prf_mapping/prf-workflow.yml.
